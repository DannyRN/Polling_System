...
Polling System API,
where anyone can create questions with options and also add votes to it. 
It is built using 
1)Express
2)Nodejs
3)MongoDB.
...
- Clients can create questions.
- Clients can add options to a question.
- Clients can add a vote to an option of question.
- Clients can delete a question -> A question can't be deleted if one of it's options has votes.
- Clients can delete an option -> An option can't be deleted if it has even one vote given to it.
- Clients can view a question with it's options and all the votes given to it.
